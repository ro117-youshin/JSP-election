   ...
   <br>
      <div id="inner">
         ...
         <%
            ...
            out.println("<td align=left class=can_name>후보명: <input type=text name=_Addname maxlength=20 id=nameid onkeyup=characterCheck(this) onkeydown=characterCheck(this)></td>");
