 ...
 <body>
   ...
   <br>
      <div id="inner">
         ...
         <!-- 기존 후보 조회 및 삭제란-->
         <%
            int new_number = Integer.parseInt(request.getParameter("_Addnumber"));
            String new_name01 = request.getParameter("_Addname");
            String new_name = new String(new_name01.getBytes("8859_1"),"utf-8");
            ...
            stmt0.execute("insert into hubo_table values ("+new_number+",'"+new_name+"');");   
            ...
            out.println("<table id=candidates>");
            out.println("<tr>");
            out.println("<td align=left class=can_number>기호번호: <input type=number id=numid name=_Addnumber min=1 readonly value="+id_number+"></td>");
            ...
            out.println("<td align=right><input type=submit class=button value=추가 id=nameid></td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</form>");
         %>
         ...
         <table id="result_table">
            <tr>
               <td id="result_message">후보 등록 결과 : 후보 등록이 완료되었습니다.</td>
            </tr>
         </table>
         <br>
      </div>
