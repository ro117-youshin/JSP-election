   ...
   <br>
      <div id="inner">
         ...
         <table id="do_vote">
            ...
            // 투표 정보 받아오기 (getParameter);
            Integer vote_number = Integer.parseInt(request.getParameter("_number"));
            Integer vote_ageGroup = Integer.parseInt(request.getParameter("_ageGroup"));
            ...
            String QueryTxt2 = String.format("insert into Tupyo_table values (" 
                                          + vote_number + "," + vote_ageGroup + ");");
            stmt2.execute(QueryTxt2);   // 데이터 추가 실행
            ...
            %>      
               ...
               <td align="left">
                  <select id="_number" name="_number" required>
                     <optgroup label="후보">
                        <%
               ...
               <td align="right"><input type="submit" onclick="location.href='./B_02.jsp'" id="button" value="투표하기"></td>
            </tr>
         </table>
         </form>
         <br>
         <table id="result_table">
            <tr>
               <td id="result_message">투표 결과 : 투표하였습니다.</td>
            </tr>
         </table>
         <br>
      </div>
